        ...
        <div className="md:flex items-center justify-between py-5 px-8 md:px-12">
          <div className="flex justify-between items-center">
            <div className="text-2xl font-bold text-gray-800 md:text-3xl">
              <Link href="/">
                <a className="nav-item nav-link">Anasayfa</a>
              </Link>
            </div>
          ...
          {/* <div className="flex flex-col md:flex-row hidden md:block -mx-2">
            <Link href="/giris">
              <a className="text-gray-800 rounded hover:bg-gray-900 hover:text-gray-100 hover:font-medium py-2 px-2 md:mx-2">Giriş Yap</a>
            </Link>
            <Link href="/kayit">
              <a className="text-gray-800 rounded hover:bg-gray-900 hover:text-gray-100 hover:font-medium py-2 px-2 md:mx-2">Kaydol</a>
            </Link>
          </div> */}
        </div>
      </nav>
